          ...
          <div class="card-item">
            ...
            <div class="col-sm-6">
              ...
              <div class="col-sm-6 d-flex align-items-center">
                <div class="card-body">
                  <h4 class="card-title">office table 1</h4>
        ...
        <div class="col-lg-6 aos-init" data-aos="fade-up" data-aos-delay="200">
          <div class="card-item">
            <div class="row">
              ...
              <div class="col-sm-6 d-flex align-items-center">
                <div class="card-body">
                  <h4 class="card-title">office table 2</h4>
                  <p>From office tables to full-service remodeling, Makiba offers a wide range of high-quality materials and craftsmanship.</p>  
                                                                   @auth('admin')
<form action="{{route('admin.change_furnitures_image')}}"method="POST"enctype="multipart/form-data">
        ...
        <div class="col-lg-6 aos-init" data-aos="fade-up" data-aos-delay="300">
          <div class="card-item">
            <div class="row">
              ...
              <div class="col-sm-6 d-flex align-items-center">
                <div class="card-body">
                  <h4 class="card-title">office table 3</h4>
...
<form action="{{route('admin.change_furnitures_image')}}"method="POST"enctype="multipart/form-data">
                                    ...
                                    @csrf
                                  <input id="image1" type="file" class="form-control @error('image') is-invalid @enderror" name="image" value="{{ old('image') }}" required autocomplete="avatar">
                                  <input id="image_id" value="{{{$images['21
                                  +3']['id']}}}" type="hidden" class="form-control @error('image_id') is-invalid @enderror"
                                   name="image_id" value="{{ old('image_id') }}"hidden autofocus>
                                 <button type="submit" class="btn btn-primary"> change</button>
                                  </form>@endauth </div>
              </div>
